...
export default function EditBudgetDialog({ open, onOpenChange, onSubmit, budget }: EditBudgetDialogProps) {
  ...
  const [services, setServices] = useState<BudgetServiceItem[]>([])
  ...
  useEffect(() => {
    if (budget) {
      ...
      setServices(budget.services.length > 0 ? [...budget.services] : [{ id: "new-1", description: "", quantity: 1, unitPrice: 0, totalPrice: 0 }])
    }
  }, [budget])
  ...
  const addService = () => {
    setServices([...services, { id: `new-${Date.now()}`, description: "", quantity: 1, unitPrice: 0, totalPrice: 0 }])
  }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const validServices = services.filter((s) => s.description && s.quantity > 0 && s.unitPrice > 0)
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Atualize os dados do orçamento</DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 border-b pb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2">
                <Label htmlFor="edit-documentTitle">Título do Documento *</Label>
                <Input
              ...
              <div className="col-span-2">
                <Label htmlFor="edit-serviceDescription">Descrição Geral do Serviço</Label>
                <Textarea
              ...
              <div className="col-span-2 sm:col-span-1">
                <Label htmlFor="edit-issueDate">Data de Emissão *</Label>
                <Input
                  id="edit-issueDate"
                  type="date"
              ...
              <div className="col-span-2 sm:col-span-1">
                <Label htmlFor="edit-validUntil">Prazo de Validade *</Label>
                <Input
                  id="edit-validUntil"
                  type="date"
